Public Class Form_SpeakAnything
    Private Sub Form_SpeakAnything_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub

    Private Sub Form_SpeakAnything_Shown(sender As Object, e As EventArgs) Handles Me.Shown
...
retry:
    ...
    Private Sub Button_SpeakOut_Click(sender As Object, e As EventArgs) Handles Button_SpeakOut.Click
